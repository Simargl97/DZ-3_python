    ...
    if len(A_num) != N or N == 0:
        ...
        for i in range(1, N):
            ...
            if count < min:
                ...
                index = i
        print(
            f'Число {A_num[index]} в списке наиболее близко по величине к числу {X}, их разница составляет {abs(X - A_num[index])}')
...
rus = {1:'АВЕИНОРСТ',
      	...
      	8:'ШЭЮ',
      	10:'ФЩЪ'}
N = abs(int(input('Введите 1, если играем в английской раскладке, либо 2, если в русской: ')))
