...
Будем считать, что на вход подается только одно слово, которое содержит либо только английские, либо только русские буква.

Задача №16 находится в файле main.py
Задача №18 находится в файле main2.py
Задача №20 находится в файле main3.py
